...
public class UserServiceImpl implements UserService {
    ...
    private void checkManagerConnections(String username) {
        ...
        // we need to implement these methods we need to have open feign dependency added in our project
        // this microservice also has some connection to the another microservice

        Integer projectCount = 0;
        // we need to send a request to project service to get the real data
    ...
    private void checkEmployeeConnections(String username) {
        ...
        if(Objects.requireNonNull(taskResponse.getBody().isSuccess())) {
            ...
            throw new TaskCountNotRetrievedException("Project count can not be retrieved");
        }
